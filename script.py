...
def main () :
    ...
    return_code = utils.execute_aflpp(aflpp_path, executable_name, local_seeddir_path, False) # TODO get is_file as an argument
    print("\nRETURN CODE = ", return_code, type(return_code))
